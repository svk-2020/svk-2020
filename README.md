<h1 align="center">Всем привет, меня зовут Станислав 🖖</h1>

## 🚀 О себе
Я Fullstack-разработчик (React / Python / FastAPI).

- Имею ранний опыт работы программистом и долгую карьеру в IT, после чего вернулся в разработку с современным стеком.
- Разработал и поддерживаю собственный проект — **Flickollect**.
- Имею практический опыт создания fullstack-приложений и их деплоя (production).
- Интересуюсь архитектурой приложений, качеством кода и удобством пользовательских интерфейсов.
- 🧑‍💻 Открыт к предложениям и ищу команду для разработки реальных продуктов.
...
### 🎬 Flickollect  
Веб-приложение для управления коллекцией фильмов.

🔗 https://www.flickollect.ru  

**Что реализовано:**
- fullstack-архитектура (frontend + backend);
- сложная модель данных (фильмы, актёры, роли);
- UI: таблицы, фильтры, админ-панель;
- REST API;
- деплой и инфраструктура (Linux, Nginx, SSL).

**Стек:**
- Backend: Python, FastAPI, SQLAlchemy, PostgreSQL  
- Frontend: Next.js, React, TypeScript, Tailwind CSS  
- State: Zustand, TanStack Table  
- DevOps: Linux, Nginx, GitHub  
...
- 📄 [Резюме](./Резюме%20-%20GitHub.pdf)  
- ✍️ Habr:  (https://habr.com/ru/articles/984450)
- 🎥 YouTube: (https://www.youtube.com/@flickollect)
